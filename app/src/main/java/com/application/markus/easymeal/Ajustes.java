...
public class Ajustes extends AppCompatPreferenceActivity {
    ...
    private static Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (preference instanceof ListPreference) {
                ...
                ((Ajustes)activity).setLanguage(stringValue);
    ...
    public void onBuildHeaders(List<Header> target) {
        loadHeadersFromResource(com.application.markus.easymeal.R.xml.pref_headers, target);
    }
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(com.application.markus.easymeal.R.xml.pref_general);
    ...
    public static class InformationPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Uri uri = Uri.fromParts("package", "com.application.markus.easymeal", null);
            intent.setData(uri);
